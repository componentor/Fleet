...
ALTER TABLE "services" ADD COLUMN IF NOT EXISTS "region" varchar;
--> statement-breakpoint
-- Add multi-cluster fields to storage_clusters
ALTER TABLE "storage_clusters" ADD COLUMN IF NOT EXISTS "name" varchar DEFAULT 'default' NOT NULL;
--> statement-breakpoint
ALTER TABLE "storage_clusters" ADD COLUMN IF NOT EXISTS "region" varchar;
--> statement-breakpoint
ALTER TABLE "storage_clusters" ADD COLUMN IF NOT EXISTS "scope" varchar DEFAULT 'regional' NOT NULL;
--> statement-breakpoint
-- Add cluster_id FK to storage_volumes
ALTER TABLE "storage_volumes" ADD COLUMN IF NOT EXISTS "cluster_id" uuid REFERENCES "storage_clusters"("id") ON DELETE SET NULL;
--> statement-breakpoint
