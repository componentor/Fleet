...
const nfsServer = ref('')
const nfsPath = ref('/exports/hoster')
...
async function completeSetup() {
  ...
  error.value = ''
  try {
    localStorage.setItem('hoster_setup_complete', 'true')
        ...
        <div v-if="currentStep === 4" class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
          <div class="p-12 text-center">
            ...
            <p class="text-gray-500 dark:text-gray-400 text-sm max-w-md mx-auto">
              Your node has been configured and is ready to join the Hoster platform. Click the button below to finish setup and start using the dashboard.
            </p>
          </div>
        </div>
